...
"                and absenmsk.NIP = pegawai.NIP and absenmsk.kdjabatan = jabatan.kdjabatan";
    ...
    public void loadData(String sql) {
        ...
        try {            
            ...
            JOptionPane.showMessageDialog(this, "terjadi kesalahan saat pengambilan data");
        }
    }
...
"                 pegawai.NIP = absenmsk.NIP and pegawai.kdkantor = kantor.kdkantor and absenmsk.kdjabatan = jabatan.kdjabatan";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String selectedNIP = tabelAbsensi.getValueAt(i, 0).toString();
        if (selectedNIP != null) {
            System.out.println(selectedNIP);
        } else {            
